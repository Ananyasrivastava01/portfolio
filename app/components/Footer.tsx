      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4 mb-6 max-w-md">
              A passionate software developer with expertise in both high-level
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-600 dark:text-gray-400">Lucknow</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Ananya Srivastava. All rights
            reserved.
          </p>
